...
class Hungbd_Filter_Block_Layer_View extends Mage_Core_Block_Template
{
    ...
    protected function _initBlocks()
    {
        ...
        $this->_categoryBlockName           = 'hungbd_filter/layer_filter_category';
        $this->_attributeFilterBlockName    = 'hungbd_filter/layer_filter_attribute';
        $this->_priceFilterBlockName        = 'hungbd_filter/layer_filter_price';
        $this->_decimalFilterBlockName      = 'hungbd_filter/layer_filter_decimal';
    }
    ...
    {
        return 'hungbd_filter/layer_filter_attribute';
    }
