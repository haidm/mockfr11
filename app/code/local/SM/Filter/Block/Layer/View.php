...
class SM_Filter_Block_Layer_View extends Mage_Core_Block_Template
{
    /**
     * State block name
     *
    ...
    protected function _initBlocks()
    {
        ...
        $this->_categoryBlockName           = 'sm_filter/layer_filter_category';
        $this->_attributeFilterBlockName    = 'sm_filter/layer_filter_attribute';
        $this->_priceFilterBlockName        = 'sm_filter/layer_filter_price';
        $this->_decimalFilterBlockName      = 'sm_filter/layer_filter_decimal';
    }
    ...
    {
        return 'sm_filter/layer_filter_attribute';
    }
