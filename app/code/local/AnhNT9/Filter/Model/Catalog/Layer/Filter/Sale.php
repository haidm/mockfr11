 ...
 * Time: 2:56 PM
 */
class AnhNT9_Filter_Model_Catalog_Layer_Filter_Sale extends Mage_Catalog_Model_Layer_Filter_Abstract
{
    ...
    public function apply(Zend_Controller_Request_Abstract $request, $filterBlock)
    {
        ...
        if (!$filter || Mage::registry('anhnt9_filter_filter')) {
            return $this;
        }
        ...
        if ($filter == self::FILTER_ON_SALE) {
            ...
            $stateLabel = Mage::helper('anhnt9_filter')->__('On Sale');
        } else {
            $select->where('price_index.final_price >= price_index.price');
            $stateLabel = Mage::helper('anhnt9_filter')->__('Not On Sale');
        }
        ...
        Mage::register('anhnt9_filter_filter', true);
    ...
    {
        return Mage::helper('anhnt9_filter')->__('Sale');
    }
    ...
    protected function _getItemsData()
    {
        ...
        $data[] = array(
            'label' => Mage::helper('anhnt9_filter')->__('On Sale'),
