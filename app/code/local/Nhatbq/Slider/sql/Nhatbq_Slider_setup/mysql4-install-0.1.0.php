...
->newTable($installer->getTable('nhatbq_slider'))
...
->newTable($installer->getTable('nhatbq_image'))
->addColumn('id', Varien_Db_Ddl_Table::TYPE_INTEGER, 11, array(
	'identity' => true,
	'unsigned' => true,
	'nullable' => false,
...
->newTable($installer->getTable('nhatbq_listimage'))
->addColumn('id', Varien_Db_Ddl_Table::TYPE_INTEGER, 11, array(
	'identity' => true,
	'unsigned' => true,
	'nullable' => false,
...
->addColumn('image_id', Varien_Db_Ddl_Table::TYPE_INTEGER, 11, array(
	...
	$installer->getFkName('nhatbq_listimage', 'slider_id', 'nhatbq_slider','id'),
	'slider_id',
	$installer->getTable('nhatbq_slider'),
	'id',
	Varien_Db_Ddl_Table::ACTION_CASCADE,
	Varien_Db_Ddl_Table::ACTION_CASCADE
)->addForeignKey(
	$installer->getFkName('nhatbq_listimage', 'image_id', 'nhatbq_image','id'),
	'image_id',
	$installer->getTable('nhatbq_image'),
	'id',
	Varien_Db_Ddl_Table::ACTION_CASCADE,
	Varien_Db_Ddl_Table::ACTION_CASCADE
);
