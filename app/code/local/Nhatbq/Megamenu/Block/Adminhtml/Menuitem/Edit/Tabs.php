...
* 
*/
class Nhatbq_MegaMenu_Block_Adminhtml_Menuitem_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
...
//        var_dump($editType);die;
        $this->addTab('form_section', array(
            ...
            'content'   => $this->getLayout()
                ->createBlock('nhatbq_megamenu/adminhtml_menuitem_edit_tab_form')
                ->toHtml()
        ));
        if ($newType == 'Custom link' || $editType->getType() == 'Custom link'){
            $this->addTab('custom_link', array(
                ...
                'title'     => "Custom Link",
                'content'   => $this->getLayout()
                    ->createBlock('nhatbq_megamenu/adminhtml_menuitem_edit_tab_customLink')
                    ->toHtml()
            ));
        }
        if ($newType == 'Category link' || $editType->getType() == 'Category link') {
            $this->addTab('category_link', array(
                ...
                'title' => "Category Link",
                'content' => $this->getLayout()
                    ->createBlock('nhatbq_megamenu/adminhtml_menuitem_edit_tab_categoryLink')
                    ->toHtml()
            ));
        }
        if ($newType == 'Product link' || $editType->getType() == 'Product link') {
            $this->addTab('product_link', array(
                ...
                'title' => "Product Link",
                'content' => $this->getLayout()
                    ->createBlock('nhatbq_megamenu/adminhtml_menuitem_edit_tab_productLink')
                    ->toHtml()
            ));
        }
